...
typedef struct table_3d_driver {
    ...
    void (*set_parameter)(void*,const table_mm_per_count_t* mmpc, const table_axis_sign_t* sign);
} table_3d_driver_t;
...
void table_set_parameter(table_3d_driver_t* d, const table_mm_per_count_t* mmpc, const table_axis_sign_t* sign);
